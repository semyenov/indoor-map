...
export const ATLAS_THEME_VARS = {
  ...
  light: {
    ...
    "--atlas-panel-blur": "blur(28px) saturate(145%)",
...
export const S: Record<string, CSSProperties> = {
  ...
  rrStepsHeader: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, flexWrap: "wrap" },
  rrStepsMeta: { fontSize: 11, color: T.sec, fontWeight: 600 },
};
