...
export const ATLAS_THEME_VARS = {
  dark: {
    "--atlas-bg": "#060e1e",
    "--atlas-glass": "rgba(8,18,44,.68)",
    "--atlas-glass-heavy": "rgba(5,11,24,.97)",
    "--atlas-chrome-surface": "rgba(120,170,255,.11)",
    "--atlas-chrome-surface-soft": "rgba(100,150,255,.07)",
    "--atlas-chrome-surface-strong": "rgba(140,185,255,.18)",
    "--atlas-panel-surface": "rgba(100,150,255,.11)",
    "--atlas-panel-surface-soft": "rgba(80,130,255,.06)",
    "--atlas-panel-surface-strong": "rgba(140,185,255,.24)",
    "--atlas-border": "rgba(120,170,255,.18)",
    "--atlas-border-strong": "rgba(140,190,255,.32)",
    "--atlas-text": "#e6eeff",
    "--atlas-sec": "rgba(200,218,255,.72)",
    "--atlas-muted": "rgba(170,196,245,.44)",
    "--atlas-accent": "#3dc8ff",
    "--atlas-accent-bg": "rgba(61,200,255,.20)",
    "--atlas-accent-bg-faint": "rgba(61,200,255,.09)",
    "--atlas-accent-border": "rgba(61,200,255,.38)",
    ...
    "--atlas-status-available-border": "rgba(47,214,142,.30)",
    "--atlas-status-available-band": "rgba(47,214,142,.22)",
    "--atlas-status-occupied": "#f96b6b",
    "--atlas-status-occupied-bg": "rgba(249,107,107,.16)",
    "--atlas-status-occupied-border": "rgba(249,107,107,.30)",
    "--atlas-status-occupied-band": "rgba(249,107,107,.24)",
    "--atlas-status-focus": "#f9c030",
    "--atlas-status-focus-bg": "rgba(249,192,48,.16)",
    "--atlas-status-focus-border": "rgba(249,192,48,.30)",
    "--atlas-status-focus-band": "rgba(249,192,48,.22)",
    "--atlas-status-offline": "#7e95b8",
    "--atlas-status-offline-bg": "rgba(126,149,184,.11)",
    "--atlas-status-offline-border": "rgba(126,149,184,.20)",
    "--atlas-status-offline-band": "rgba(126,149,184,.14)",
  ...
  light: {
    "--atlas-bg": "#e2e8ef",
    "--atlas-glass": "rgba(246,250,253,.86)",
    "--atlas-glass-heavy": "rgba(252,254,255,.95)",
    "--atlas-chrome-surface": "rgba(255,255,255,.90)",
    "--atlas-chrome-surface-soft": "rgba(247,250,253,.72)",
    "--atlas-chrome-surface-strong": "rgba(255,255,255,.97)",
    "--atlas-panel-surface": "rgba(248,251,254,.82)",
    "--atlas-panel-surface-soft": "rgba(239,245,250,.58)",
    "--atlas-panel-surface-strong": "rgba(255,255,255,.94)",
    "--atlas-border": "rgba(26,56,82,.15)",
    "--atlas-border-strong": "rgba(26,56,82,.28)",
    "--atlas-text": "#102334",
    "--atlas-sec": "rgba(16,35,52,.76)",
    "--atlas-muted": "rgba(16,35,52,.52)",
    "--atlas-accent": "#0a78b8",
    "--atlas-accent-bg": "rgba(10,120,184,.11)",
    "--atlas-accent-bg-faint": "rgba(10,120,184,.045)",
    "--atlas-accent-border": "rgba(10,120,184,.26)",
    "--atlas-hover-surface": "rgba(20,53,80,.065)",
    "--atlas-focus-surface": "rgba(10,120,184,.115)",
    "--atlas-btn-surface": "rgba(252,254,255,.92)",
    "--atlas-btn-surface-hover": "rgba(255,255,255,.98)",
    "--atlas-btn-surface-active": "rgba(10,120,184,.10)",
    "--atlas-btn-primary-bg": "rgba(10,120,184,.13)",
    "--atlas-btn-primary-bg-hover": "rgba(10,120,184,.22)",
    "--atlas-btn-primary-text": "#0a78b8",
    "--atlas-control-shadow": "inset 0 1px 0 rgba(255,255,255,.88), 0 2px 10px rgba(16,36,56,.08)",
    "--atlas-elev-top": "0 4px 14px rgba(16,36,56,.08), 0 10px 28px rgba(16,36,56,.07)",
    "--atlas-elev-bottom": "0 -2px 18px rgba(16,36,56,.10)",
    "--atlas-elev-drawer": "0 10px 34px rgba(16,36,56,.12)",
    "--atlas-elev-side": "-6px 0 22px rgba(16,36,56,.10)",
    "--atlas-elev-floating": "0 4px 12px rgba(16,36,56,.10), 0 8px 24px rgba(16,36,56,.08)",
    "--atlas-elev-accent": "inset 0 0 0 1px rgba(10,120,184,.14)",
    "--atlas-elev-accent-active": "inset 0 0 0 1px rgba(10,120,184,.24)",
    "--atlas-status-available": "#11885d",
    "--atlas-status-available-bg": "rgba(17,136,93,.10)",
    "--atlas-status-available-border": "rgba(17,136,93,.22)",
    "--atlas-status-available-band": "rgba(17,136,93,.14)",
    "--atlas-status-occupied": "#d34848",
    "--atlas-status-occupied-bg": "rgba(211,72,72,.10)",
    "--atlas-status-occupied-border": "rgba(211,72,72,.22)",
    "--atlas-status-occupied-band": "rgba(211,72,72,.14)",
    "--atlas-status-focus": "#b67a12",
    "--atlas-status-focus-bg": "rgba(182,122,18,.10)",
    "--atlas-status-focus-border": "rgba(182,122,18,.22)",
    "--atlas-status-focus-band": "rgba(182,122,18,.14)",
    "--atlas-status-offline": "#66758a",
    "--atlas-status-offline-bg": "rgba(102,117,138,.08)",
    "--atlas-status-offline-border": "rgba(102,117,138,.17)",
    "--atlas-status-offline-band": "rgba(102,117,138,.11)",
    "--atlas-scrollbar-thumb": "rgba(20,50,78,.16)",
    "--atlas-panel-blur": "blur(24px) saturate(145%)",
    "--atlas-overlay": "rgba(16,36,56,.05)",
  },
} as const;
export const T = {
  bg: "var(--atlas-bg)",
...
export const S: Record<string, CSSProperties> = {
  ...
  topBrandText: { fontWeight: 700, fontSize: 14, letterSpacing: "-.02em" } as CSSProperties,
  ...
  routeChoiceName: { fontSize: 13, fontWeight: 700, lineHeight: 1.2, minWidth: 0 },
  ...
  personCard: { display: "flex", flexDirection: "column", gap: 10, padding: "12px 14px", background: T.panelSurfaceStrong, border: T.controlBorder, boxShadow: T.controlShadow, borderRadius: 0, textAlign: "left", fontFamily: FONT, color: T.text, minHeight: 88 },
  personTitleRow: { display: "flex", alignItems: "center", gap: 10, minWidth: 0 },
  personAv: { width: 28, height: 28, borderRadius: "50%", background: `linear-gradient(135deg,${T.accentBg},${T.accentBgFaint})`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, color: T.accent, flexShrink: 0 },
  personName: { fontSize: 13, fontWeight: 700, color: T.text, lineHeight: 1.2, minWidth: 0 } as CSSProperties,
  sectionGroupLabel: { ...mutedSectionLabelBase } as CSSProperties,
  routePanel: {
    width: "100%",
    height: "100%",
    maxWidth: "none",
  ...
  rpPlannerBar: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 36px minmax(0,1fr)", gap: 10, alignItems: "stretch", flexShrink: 0, minWidth: 0, padding: 0, background: "transparent", border: "none", boxShadow: "none" },
  rpPlannerCard: {
    display: "flex",
    flexDirection: "column",
    justifyContent: "center",
  ...
  rrStepNHovered: { background: T.accentBg, border: `1px solid ${T.accentBorder}`, color: T.accent },
  rrStepNLast: { background: T.accent, border: `1px solid ${T.accent}`, color: T.glassH },
  rrStepBody: { display: "flex", alignItems: "center", minWidth: 0, flex: 1, minHeight: 24 },
  rrStepT: { fontSize: 13, color: T.sec, lineHeight: 1.45, fontWeight: 600, minWidth: 0 },
  rrStepTHovered: { color: T.text },
  rrStepsGrid: { display: "grid", gap: 12, alignItems: "start" },
  rrStepsColumn: { display: "grid", alignContent: "start", gap: 10, minWidth: 0 },
  ...
  opsRoomName: { fontSize: 14, fontWeight: 700, lineHeight: 1.2, minWidth: 0 },
