...
const MAP_PALETTES = {
  light: {
    background: "#e5ebf1",
    circulationFill: "#d8e2e9",
    workspaceFill: "#d9e5dd",
    meetingFill: "#e1c8b0",
    amenityFill: "#cfe0ee",
    engineeringFill: "#cfe1d6",
    operationsFill: "#c7d9ea",
    productFill: "#ddd4ec",
    designFill: "#e6d2dc",
    sharedFill: "#e2d7bf",
    circulationAccentFill: "#cddae3",
    verticalFill: "#d7dceb",
    selectedFill: "#2fa9e2",
    hoverFill: "#77c4e6",
    outline: "#5c6d7a",
    selectedOutline: "#0a82c6",
    hoverOutline: "#2f98c6",
    wall: "#8c98a3",
    wallOpacity: 0.62,
    door: "#be8751",
    furniture: "#aab4bc",
    connector: "#c8d3dc",
    connectorSelected: "#ddb371",
    routeCasing: "rgba(252,254,255,0.92)",
    routeLine: "#d8565f",
    workstation: "#27485f",
    connectorPoi: "#d86167",
    poiHover: "#2f97c2",
    ...
    label: "#223748",
    labelHover: "#1f7096",
    labelSelected: "#0b6594",
    labelHalo: "rgba(248,251,253,0.98)",
  },
  dark: {
    background: "#11171c",
